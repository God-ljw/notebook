...
==Request是请求对象，Response是响应对象。==这两个对象在我们使用Servlet的时候有看到：![1628735216156](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656632.png)

此时，我们就需要思考一个问题request和response这两个参数的作用是什么?

![1628735746602](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656634.png)
...
![1628738273049](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656635.png)
...
![1628740441008](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656636.png)

从上图中可以看出，ServletRequest和HttpServletRequest都是Java提供的，所以我们可以打开JavaEE提供的API文档[参考: 资料/JavaEE7-api.chm],打开后可以看到:

![1628741839475](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656637.png)

所以ServletRequest和HttpServletRequest是继承关系，并且两个都是接口，接口是无法创建对象，这个时候就引发了下面这个问题:

![1628742224589](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656638.png)
...
![1628743040046](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656639.png)
...
![1628748240075](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656640.png)
...
![1628762794935](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656641.png)

#### 2.2.2 获取请求头数据

对于请求头的数据，格式为`key: value`如下:

![1628768652535](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656643.png)
...
![1628769145524](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656644.png)

#### 2.2.3 获取请求体数据

浏览器在发送GET请求的时候是没有请求体的，所以需要把请求方式变更为POST，请求体中的数据格式如下:

![1628768665185](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656645.png)
...
![1628770516387](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656646.png)

点击`提交`按钮后，就可以在控制台看到前端所发送的请求数据

![1628770585480](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656647.png)
...
![1628776252445](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656648.png)

* 如何解决上述重复代码的问题呢?

![1628776433318](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656649.png)
...
![1628778931277](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656650.png)

(2)把获取到的内容进行分割，内容如下:

![1628779067793](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656651.png)

(3)把分割后端数据，存入到一个Map集合中:

![1628779368501](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656652.png)
...
![1628780937599](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656653.png)
...
![1628780965283](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656654.png)
...
![1628781031437](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656655.png)
...
![1628781176434](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656656.png)
...
![1628781419752](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656657.png)

由于格式固定，所以我们可以使用IDEA提供的模板来制作一个Servlet的模板，这样我们后期在创建Servlet的时候就会更高效，具体如何实现:

(1)按照自己的需求，修改Servlet创建的模板内容

![1628781545912](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656658.png)

（2）使用servlet模板创建Servlet类

![1628782117420](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656659.png)
...
![1628784323297](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656660.png)

（4）查看控制台打印内容

![1628784356157](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656661.png)

（5）把req.html页面的请求方式改成post,再次发送请求和中文参数

![1628784425182](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656663.png)
...
1. 首先我们需要先分析下GET请求出现乱码的原因:
 ...
 ![1628829610823](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656664.png)
...
![1628833310473](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656665.png)

就可以获取张和三分别对应的10进制，然后在使用计算器，选择程序员模式，计算出对应的二进制数据结果:

![1628833496171](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656666.png)

在计算的十六进制结果中，每两位前面加一个%,就可以获取到`%E5%BC%A0%E4%B8%89`。

当然你从上面所提供的网站中就已经能看到编码16进制的结果了:

![1628833310473](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656667.png)
...
![1628846824194](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656668.png)
...
![1628849231208](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656669.png)
...
![1628851404283](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656670.png)
...
![1628854783523](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656671.png)

- **重定向和请求转发的区别：**
- ![image-20220720152819031](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207201528220.png)
...
![1628855192876](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656672.png)
...
![1628856995417](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656673.png)
...
![1628857213364](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656674.png)
...
* 浏览器地址栏路径不发生变化
  ...
  ![1628857365153](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656675.png)
...
![1628857632899](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656676.png)
...
![1628857761317](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656677.png)
...
![1628858926498](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656678.png)
...
![1628859051368](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656679.png)
...
![1628859268095](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656680.png)
...
![1628859860279](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656681.png)
...
// 简化重定向写法
response.sendRedirect("/requst-demo/resp2");
```

具体如何来使用，我们先来看下需求:

![1628861030429](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656682.png)
...
![1628861404699](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656683.png)
...
* 浏览器地址栏路径发送变化
  ...
  ![1628861893130](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656684.png)
...
![1628862170296](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656685.png)
...
![1628862652700](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656686.png)
...
![1628863270545](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656687.png)
...
![1628863905362](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656688.png)
...
![1628864140820](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656689.png)
...
![1628864390263](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656690.png)
...
![1628864883564](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656691.png)
...
![1628865728305](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656692.png)
...
![1628866248169](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656693.png)

2. 创建db1数据库，创建tb_user表，创建User实体类

2.1 将`资料\1. 登陆注册案例\2. MyBatis环境\tb_user.sql`中的sql语句执行下:

![1628866403891](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656694.png)

 2.2 将`资料\1. 登陆注册案例\2. MyBatis环境\User.java`拷贝到com.itheima.pojo

![1628866560738](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656695.png)
...
![1628867237329](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656696.png)
...
![1628867761245](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656697.png)

4.2 如果用户名和密码输入正确，则

![1628867801708](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656698.png)
...
![1628867904783](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207171656699.png)
