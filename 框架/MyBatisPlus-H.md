...
> 了解MyBatisPlus的代码生成器
>
> ![image-20220914013258989](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202209140133569.png)
...
* 创建SpringBoot工程
  ...
  ![1630997819698](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191651892.png)

* 勾选配置使用的技术，能够实现自动添加起步依赖包

  ![1630997860020](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191651938.png)

* 设置dataSource相关属性(JDBC参数)

  ![1630997901479](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652080.png)

* 定义数据层接口映射配置

  ![1630997929891](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652405.png)
...
![1630998241426](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652000.png)

#### 步骤3:勾选配置使用技术

![1630998321660](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652125.png)
...
* 从MP的依赖关系可以看出，通过依赖传递已经将MyBatis与MyBatis整合Spring的jar包导入，我们不需要额外在添加MyBatis的相关jar包
  ...
  ![1631206757758](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652481.png)
...
![1630999646096](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652119.png)
...
![1631011942323](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652023.png)

现在的页面中，这一行已经被删除，现在再去访问`https://mybatis.plus`会发现访问不到，这个就有很多可能性供我们猜想了，所以大家使用baomidou的网址进行访问即可。

官方文档中有一张很多小伙伴比较熟悉的图片:

![1631012174092](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652455.png)
...
![1631018877517](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652034.png)
...
![1631013124310](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652236.png)
...
* Serializable：参数类型
  ...
  * 思考:参数类型为什么是一个序列化类?
    ...
    ![1631013655771](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652511.png)
...
![1631016543648](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652168.png)
...
![1631016876641](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652917.png)
...
![1631208030131](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652622.png)

#### 步骤3:运行测试程序

![1631019660480](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652602.png)
...
![1631020283701](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652763.png)
...
* 编写测试类
  ...
  ![1631033477792](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652462.png)
...
* 测试的时候，控制台打印的日志比较多，速度有点慢而且不利于查看运行结果，所以接下来我们把这个日志处理下:
  ...
  * 取消MybatisPlus启动banner图标
    ...
    ![1631021315906](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652420.png)
  ...
  * 取消SpringBoot的log打印
    ...
    ![1631021269422](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191652855.png)
...
![1631021942869](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653231.png)
...
![1631023641992](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653975.png)
...
![1631024145264](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653959.png)
...
* lt()方法
  ...
  ![1631025068317](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653780.png)
...
![1631209838333](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653440.png)
...
![1631030296965](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653510.png)
...
![1631030550100](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653192.png)
...
![1631031054206](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191653580.png)
...
![1631031270558](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654949.png)
...
![1631031828378](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654304.png)

解决方案是使用MP提供的另外一个注解`@TableName`来设置表与模型类之间的对应关系。

![1631031915632](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654910.png)
...
![1631032123894](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654970.png)
...
![1631032283147](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654421.png)
...
![1631032450558](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654750.png)
...
- 最终创建的项目结构为:
  ...
  ![1631033634879](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654943.png)
...
* 删除测试数据
  ...
  ![1631211291677](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654542.png)

* 因为之前生成主键ID的值比较长，会把MySQL的自动增长的值变的很大，所以需要将其调整为目前最新的id值。

![1631211080703](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191654811.png)

###### 步骤3:运行新增方法  

会发现，新增成功，并且主键id也是从5开始

![1631211383421](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655144.png)
...
![1631211697712](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655169.png)

当把源码下载完后，就可以看到如下内容:

![1631211902833](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655934.png)
...
![1631212246124](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655830.png)
...
![1631242753467](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655064.png)
...
![1631243694870](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655840.png)
...
![1631243810974](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655194.png)
...
![1631243987800](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655240.png)
...
对于主键ID的策略已经介绍完，但是如果要在项目中的每一个模型类上都需要使用相同的生成策略，如:![1631245676125](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655494.png)
...
![1631245757169](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655072.png)
...
![1631246166514](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655915.png)
...
![1631246688218](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655894.png)

### 4.3 逻辑删除

接下来要讲解是删除中比较重要的一个操作，逻辑删除，先来分析下问题:

![1631246806130](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655317.png)
...
* 所以经过分析，我们不应该将表中的数据删除掉，而是需要进行保留，但是又得把离职的人和在职的人进行区分，这样就解决了上述问题，如:
  ...
  ![1631247188218](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655876.png)
...
![1631247439168](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191655162.png)
...
![1631247818327](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656299.png)
...
* 执行查询操作
  ...
  ![1631248019999](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656116.png)
...
![1631248494929](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656451.png)
...
![1631249913103](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656676.png)
...
![1631252305080](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656629.png)
...
![1631252393659](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656537.png)
...
![1631252667865](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656638.png)
...
![1631253302587](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656106.png)
...
造句:![1631253928893](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191657391.png)

我们可以往空白内容进行填词造句，比如:![1631253971409](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191657618.png)

在比如:![1631253994782](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191657932.png)

观察我们之前写的代码，会发现其中也会有很多重复内容，比如:

![1631254075651](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191656779.png)

那我们就想，如果我想做一个Book模块的开发，是不是只需要将红色部分的内容全部更换成`Book`即可，如：

![1631254119948](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191657861.png)
...
![1631254344180](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191657613.png)
...
![1631255110375](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191657944.png)
