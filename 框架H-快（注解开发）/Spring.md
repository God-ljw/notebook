...
* 从使用和占有率看
  ...
  * 所以说,Spring技术是JavaEE开发必备技能，企业开发技术选型命中率>==90%==
    ...
    ![image-20210729171139088](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082232373.png)
...
* Spring发展到今天已经形成了一种开发的生态圈,Spring提供了若干个项目,每个项目用于完成特定的功能。
  ...
  * Spring有若干个项目，可以根据需要自行选择，把这些个项目组合起来，起了一个名称叫==全家桶==，如下图所示
    ...
    ![image-20210729171850181](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082232961.png)
    ...
    **说明:**
    ...
    ![1629714811435](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082232033.png)
...
![image-20210729171926576](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082232227.png)
...
* Spring Framework的发展也经历了很多版本的变更，每个版本都有相应的调整
  ...
  ![image-20210729172153796](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233700.png)

* Spring Framework的5版本目前没有最新的架构图，而最新的是4版本，所以接下来主要研究的是4的架构图

  ![1629720945720](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233895.png)
...
![1629722300996](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233904.png)
...
![1629723232339](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233976.png)
...
![1629724206002](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233092.png)
...
![1629735078619](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233507.png)
...
![1629734010072](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233944.png)
...
![1629734336440](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233807.png)
...
![image-20210729184337603](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233970.png)
...
![1629736314989](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233525.png)

##### 步骤4:运行程序

运行，测试结果为：

![image-20220809155522618](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091555714.png)

##### 总结

**DI注入就是为了不用new一个对象**，注意和下面的bean实例化区别开来，因为**这里是pravite一个对象**，而下面的**bean实例化对象是在一个工厂类中提供一个方法来返回了一个对象**。【**这里的DI注入是没有一个工厂来返回对象只有自己定义了一个pravite对象**】--> 步骤：首先是在被bean的类中pravite一个对象 然后再提供一个set方法 再最后再applicationContext.xml文件中配置bean具体看上面【记得在bean中写property标签】
...
![image-20210729183500978](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233023.png)
...
* 重新搭建一个新的案例环境,目的是方便大家查阅代码
  ...
  * 搭建的内容和前面的案例是一样的，内容如下：
    ...
    ![1629769227068](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233470.png)
...
![image-20210729183558051](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233140.png)
...
![image-20210729184337603](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233994.png)

==注意事项:==

* bean依赖注入的ref属性指定bean，必须在容器中存在

  ![1629771744003](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233025.png)
...
* 如果不存在,则会报错，如下:
  ...
  ![1629771972886](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082233372.png)
...
![image-20210729183628138](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234941.png)
...
* 打印，观察控制台的打印结果
  ...
  ![1629772538893](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234783.png)
...
* 将scope设置为`singleton`
  ...
  ![1629772538893](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234827.png)
...
* 将scope设置为`prototype`
  ...
  ![1629772928714](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234927.png)
...
![1631529887695](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234725.png)

### 4.2 bean实例化*（三种）

**实例化对象其实说白了就是new一个对象出来**
...
![1629775585694](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234740.png)
...
![1629775972507](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234467.png)
...
![1629775972507](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234983.png)
...
![1629776331499](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234144.png)
...
**(2)创建一个工厂类OrderDaoFactory并提供一个==静态方法==（重点是提供一个<u>静态</u>方法放回一个new 对象）**
...
![1629786862329](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234573.png)
...
![image-20220809152141674](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091521293.png)
...
![1629786862329](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234183.png)
...
![1629788036885](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234961.png)
...
public class UserDaoFactory {
    public UserDao getUserDao(){  // 这里没有static
...
![1629788769436](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234576.png)
...
* 调用对象中的方法来创建bean，对应的是第二行配置
  ...
  * factory-method:工厂对象中的具体创建对象的方法名,对应关系如下:
    ...
    ![image-20210729200203249](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234394.png)
...
![1629788769436](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082234276.png)

实例工厂实例化的方式就已经介绍完了，配置的过程还是比较复杂，所以Spring为了简化这种配置方式就提供了一种叫`FactoryBean`的方式来简化开发。

##### 4.2.3.3 FactoryBean的使用（常用）
...
![1629788769436](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235907.png)
...
![1629790070607](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235427.png)
...
![1629790197860](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235741.png)
...
```
构造方法 底层用的是映射  当构造方法中带有参数时会报错具体看下面
```
...
![1629791473409](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235735.png)
...
![1629792339889](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235986.png)
...
* 运行程序，就能执行destroy方法的内容
  ...
  ![1629792857608](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235053.png)
...
* 运行后，查询打印结果
  ...
  ![1629792857608](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235850.png)
...
![1629794527419](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235210.png)

那第二种方式的实现，我们也介绍完了。

**小细节**

* 对于**InitializingBean接口中的afterPropertiesSet方法，翻译过来为`属性设置之后` 就是在属性设置完以后才会执行（就是在set执行后才会执行）**。
...
* 思考:afterPropertiesSet和setBookDao谁先执行?
  ...
  * 重新运行AppForLifeCycle，打印结果如下:
    ...
    ![1629794928636](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235374.png)
...
![1629799214191](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235905.png)
...
![1629799873386](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082235700.png)
...
![1629800324721](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236112.png)

**注意:**两个property注入标签的顺序可以任意。

对于**setter注入方式**的基本使用就已经介绍完了，
...
![1629800748639](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236977.png)
...
![1629802656916](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236170.png)
...
![1629802697318](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236399.png)
...
![1629803111769](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236766.png)

上面已经完成了构造函数注入的基本使用，但是会存在一些问题:

![1629803529598](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236069.png)
...
![1629805387647](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236948.png)
...
* 按照名称注入中的名称指的是什么?
  ...
  ![1629806856156](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236232.png)
...
![1629807579330](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236223.png)
...
![1629808046783](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208082236864.png)
...
* 创建一个Maven项目
  ...
  ![1629860338328](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091439013.png)
...
![1629887733081](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091439420.png)
...
* 从mvn的仓库`https://mvnrepository.com/`中进行搜索
  ...
  ![1629888540286](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091439607.png)
...
![1629889170229](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091439084.png)
...
![1629903845404](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440058.png)
...
![1629975492444](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440156.png)
...
* 问题一:键值对的key为`username`引发的问题
  ...
  ![1629975934694](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440668.png)
...
#### 1.2.3 加载properties文件小结
  ...
  * 如何开启`context`命名空间
    ...
    ![1629980280952](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440499.png)
...
![1629982672522](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440420.png)
...
![1629983245121](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440995.png)
...
![1629985148294](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440547.png)

(2)点击进入BeanFactory类，ctrl+h,就能查看到如下结构的层次关系

![1629984980781](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440213.png)
...
![1629986510487](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440580.png)
...
![1629986848563](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440885.png)
...
![1629989221808](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440804.png)
...
![1629990315619](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440973.png)
...
![1630027590558](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440730.png)
...
![1630027743910](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440802.png)
...
![1630028345074](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091440240.png)
...
![1630029110506](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441687.png)

至此，纯注解开发的方式就已经完成了，主要内容包括:

* Java类替换Spring核心配置文件

  ![1630029254372](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441919.png)
...
![1630031112993](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441050.png)

#### 3.3.2 Bean的作用范围

(1)先运行App类,在控制台打印两个一摸一样的地址，说明默认情况下bean是单例

![1630031192753](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441708.png)
...
![1630031808947](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441672.png)
...
![1630032385498](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441309.png)
...
![1630033039358](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441669.png)
...
![1630033604129](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441673.png)

环境准备好后，运行后会发现有问题

![1630033710052](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441451.png)
...
![1630034272959](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441855.png)
...
* 先给两个Dao类分别起个名称
  ...
  * 分析下面这种情况是否能完成注入呢?
    ...
    ![1630036236150](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441372.png)
...
![1630084683663](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441326.png)
...
![1630122466404](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091441019.png)
...
![image-20220814171908057](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208141719324.png)
...
![1630134786448](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442853.png)

![image-20230104171816588](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301041718679.png)
...
**Java Bean，Entity，POJO，domain就是放实体类的包**
...
![1630136904087](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442711.png)
...
* Mybatis程序核心对象分析
  ...
  ![1630137189480](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442627.png)

  从图中可以获取到，真正需要交给Spring管理的是==SqlSessionFactory==

* 整合Mybatis，就是将Mybatis用到的内容交给Spring管理，分析下配置文件

  ![1630137388717](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091443181.png)
...
* 使用SqlSessionFactoryBean封装SqlSessionFactory需要的环境信息
  ...
  ![1630138835057](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442204.png)
...
* 使用MapperScannerConfigurer加载Dao接口，创建代理对象保存到IOC容器中
  ...
  ![1630138916939](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442249.png)
...
![1630139036627](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442044.png)
...
![1630139720273](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091442820.png)
...
![1630143927489](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091443120.png)
...
![1630144353462](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091443051.png)

(1)前面一直在强调，Spring的AOP是对一个类的方法在不进行任何修改的前提下实现增强。对于上面的案例中BookServiceImpl中有`save`,`update`,`delete`和`select`方法,这些**方法**我们给起了一个名字叫==**连接点**==

(2)在BookServiceImpl的四个方法中，`update`和`delete`只有打印没有计算万次执行消耗时间，但是在运行的时候已经有该功能，那也就是说`update`和`delete`方法都已经被增强，所以对于**需要增强的方法我们给起了一个名字叫==切入点**==
...
![1630167092142](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444176.png)
...
![1630146885493](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444795.png)
...
![1630148447689](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444044.png)
...
![1630147945888](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444641.png)
...
![1630151682428](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444372.png)
...
* 要被实例化bean对象的类中的方法和切入点进行匹配
  ...
  ![1630152538083](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444230.png)
...
![1630154495165](../../../../../../../../第三阶段框架/第二阶段/3.2、2022版SSM框架/SSM资料/课程笔记/基础框架8笔记/Spring笔记/spring_day03/assets/1630154495165.png)
...
![1630154625564](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444560.png)
...
![1630155937718](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444769.png)
...
![1630156172790](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445183.png)
...
![1630163744963](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444289.png)
...
![1630164718080](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444422.png)
...
![1630166147697](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444287.png)
...
![1630167385146](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444194.png)
...
![1630167805723](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444449.png)
...
![1630167887131](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091444402.png)
...
![1630167969051](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445571.png)
...
![1630168248052](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445403.png)

再次运行，程序可以看到原始方法已经被执行了

![1630168293492](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445749.png)
...
![1630169124446](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445768.png)
...
![1630169357146](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445247.png)
...
![1630170090945](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445959.png)
...
![1630214631112](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445310.png)
...
![1630215355776](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445458.png)
...
![1630215743444](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091445850.png)
...
![1630233154992](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446664.png)
...
![1630233291929](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446607.png)
...
![1630233548743](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446335.png)
...
![1630233974310](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446173.png)

**注意:**

* pjp.proceed()方法是有两个构造方法，分别是:

  ![1630234756123](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446216.png)
...
![1630237320870](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446946.png)
...
![1630237586682](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446915.png)

运行App后查看运行结果，说明返回值已经被获取到

![1630237372286](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446870.png)
...
![1630239939043](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446891.png)

运行App后，查看控制台，就能看的异常信息被打印到控制台

![1630239997560](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446913.png)
...
![1630240203033](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446291.png)

问题描述:

* 点击链接，会提示，请输入提取码，如下图所示

  ![1630240528228](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446562.png)
...
![1630241681697](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446585.png)
...
![1630242491831](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446147.png)
...
![1630243651541](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446580.png)

commit是用来提交事务，rollback是用来回滚事务。

PlatformTransactionManager只是一个接口，Spring还为其提供了一个具体的实现:

![1630243993380](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091446390.png)
...
![1630247220645](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091447569.png)
...
![1630248794837](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091447642.png)
...
![1630249111055](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091447398.png)
...
![1630250069844](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091447453.png)
...
![1630253779575](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091447043.png)
...
![1630254257628](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208091447525.png)
