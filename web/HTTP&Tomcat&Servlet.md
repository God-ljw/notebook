...
![1627031933553](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161543775.png)
...
![1627037814180](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544041.png)
...
![1627038674340](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544161.png)
#### 1.2.4 数据库
* 数据库主要负责存储数据。
* 整个Web的访问过程就如下图所示:
![1627039320220](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544162.png)
...
![1627043194238](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544163.png)
...
![1627046235092](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544164.png)
...
![1627050004221](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544165.png)
...
* 请求体: POST请求的最后一部分，存储请求参数
   ...
   ![1627050930378](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544166.png)
...
![1627278511902](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544167.png)

使用IDEA打开

![1627278583127](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544168.png)

打开后，可以点击项目中的`html\19-表单验证.html`，使用浏览器打开，通过修改页面中form表单的method属性来测试GET请求和POST请求的参数携带方式。

![1627278725007](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544169.png)
...
![1627053710214](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544170.png)
...
![1627058356051](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544171.png)
...
![1627060368806](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544172.png)
...
![1627176045795](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544173.png)
...
![1627178001030](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544174.png)
...
* 打开`apache-tomcat-8.5.68`目录就能看到如下目录结构，每个目录中包含的内容需要认识下,
  ...
  ![1627178815892](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544175.png)
...
![1627179006011](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544177.png)

启动后，通过浏览器访问 `http://localhost:8080`能看到Apache Tomcat的内容就说明Tomcat已经启动成功。

![1627199957728](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544178.png)

==注意==: 启动的过程中，控制台有中文乱码，需要修改conf/logging.prooperties

![1627199827589](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544179.png)
...
![1627200509883](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544180.png)
...
* Tomcat的端口号取值范围是0-65535之间任意未被占用的端口，如果设置的端口号被占用，启动的时候就会包如下的错误
  ...
  ![1627200780590](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544181.png)

* Tomcat启动的时候，启动窗口一闪而过: 需要检查JAVA_HOME环境变量是否正确配置

![1627201248802](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544182.png)
...
* Tomcat部署项目： 将项目放置到webapps目录下，即部署完成。
  ...
  * 通过浏览器访问`http://localhost/hello/a.html`，能看到下面的内容就说明项目已经部署成功。
    ...
    ![1627201572748](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544183.png)
...
* 一般JavaWeb项目会被打包称==war==包，然后将war包放到Webapps目录下，Tomcat会自动解压缩war文件
  ...
  * 通过浏览器访问`http://localhost/haha/a.html`，能看到下面的内容就说明项目已经部署成功。
    ...
    ![1627201868752](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544184.png)
...
* Maven Web项目结构: 开发中的项目
  ...
  ![1627202865978](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544185.png)

* 开发完成部署的Web项目

  ![1627202903750](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544186.png)
...
1. 创建Maven项目
   ...
   ![1627227574092](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544187.png)

2. 选择使用Web项目骨架

   ![1627227650406](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544188.png)

3. 输入Maven项目坐标创建项目

   ![1627228065007](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544189.png)

4. 确认Maven相关的配置信息后，完成项目创建

   ![1627228413280](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544190.png)

5. 删除pom.xml中多余内容，只留下面的这些内容，注意打包方式 jar和war的区别

   ![1627228584625](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544191.png)

6. 补齐Maven Web项目缺失的目录结构，默认没有java和resources目录，需要手动完成创建补齐，最终的目录结果如下

   ![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544192.png)
...
1. 创建Maven项目
   ...
   ![1627229111549](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544193.png)

2. 选择不使用Web项目骨架

   ![1627229137316](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544194.png)

3. 输入Maven项目坐标创建项目

   ![1627229371251](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544195.png)

4. 在pom.xml设置打包方式为war,默认是不写代表打包方式为jar

   ![1627229428161](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544196.png)

5. 补齐Maven Web项目缺失webapp的目录结构

   ![1627229584134](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544197.png)

6. 补齐Maven Web项目缺失WEB-INF/web.xml的目录结构

   ![1627229676800](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544198.png)
...
7. 补充完后，最终的项目结构如下:
   ...
   ![1627229478030](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544199.png)
...
![1627204022604](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544200.png)

> 3.掌握不使用骨架的方式创建Maven Web项目

![1627204076090](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544201.png)
...
1. 打开添加本地Tomcat的面板
   ...
   ![1627229992900](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544202.png)

2.  指定本地Tomcat的具体路径

   ![1627230313062](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544203.png)

3. 修改Tomcat的名称，此步骤可以不改，只是让名字看起来更有意义，HTTP port中的端口也可以进行修改，比如把8080改成80

   ![1627230366658](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544204.png)

4. 将开发项目部署项目到Tomcat中

   ![1627230913259](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544205.png)
...
5. 部署成功后，就可以启动项目，为了能更好的看到启动的效果，可以在webapp目录下添加a.html页面
   ...
   ![1627233265351](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544206.png)

6. 启动成功后，可以通过浏览器进行访问测试

   ![1627232743706](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544207.png)

7. 最终的注意事项

   ![1627232916624](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544208.png)

   

至此，IDEA中集成本地Tomcat进行项目部署的内容我们就介绍完了，整体步骤如下，大家需要按照流程进行部署操作练习。

![1627205657117](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544209.png)
...
![1627233963315](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544210.png)

==注意:==

* 如果选中项目并右键点击后，看不到Run Maven和Debug Maven，这个时候就需要在IDEA中下载Maven Helper插件，具体的操作方式为: File --> Settings --> Plugins --> Maven Helper ---> Install,安装完后按照提示重启IDEA，就可以看到了。

![1627234184076](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544211.png)
...
## 4， Servlet（记得看pom.xml）

### 4.1 简介

![1627234763207](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544212.png)
...
* Servlet是JavaEE规范之一，其实就是一个接口，将来我们需要定义Servlet类实现Servlet接口，并由web服务器运行Servlet
  ...
  ![1627234972853](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544213.png)
...
![1627236923139](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544214.png)
...
* 通过案例演示下上述的生命周期
  ...
  */
  ...
  ![1627239292226](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544215.png)
...
![1627240593506](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544216.png)
...
* 一个Servlet,可以配置多个urlPattern
  ...
  ![1627272805178](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544217.png)
...
* ==urlPattern配置规则==
  ...
  * 精确匹配
    ...
    ![1627273174144](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544218.png)
  ...
  * 目录匹配
    ...
    ![1627273184095](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544219.png)
  ...
  * 扩展名匹配
    ...
    ![1627273194118](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544220.png)
    ...
    ![1627274483755](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544221.png)

    2. 如果路径配置的是`*.do`,那么在*.do的前面不能加`/`,否则会报错

    ![1627274368245](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544222.png)

  * 任意匹配

    ![1627273201370](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202207161544223.png)
