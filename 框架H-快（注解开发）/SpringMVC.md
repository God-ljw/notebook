...
![1630427303762](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023635.png)
...
![1630427769938](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023452.png)
...
![image-20230116001329583](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301160013755.png)

![image-20230116001619319](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301160016408.png)

![image-20230116001654397](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301160016483.png)
...
![1630428920116](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023006.png)

#### 步骤2:补全目录结构

因为使用骨架创建的项目结构不完整，需要手动补全

![1630429288339](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023827.png)
...
public class UserController {
    ...
    //2.3设置当前操作发返回值类型
    //@ResponseBody
    public void save(){ // 没改之前void->String
...
![1630430302683](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023141.png)

#### 步骤8:启动运行项目

![1630430345246](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023626.png)

#### 步骤9:浏览器访问

浏览器输入`http://localhost/save`进行访问，会报如下错误:

#### ![1630430401561](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023790.png)
...
![1630430658028](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023038.png)
...
![1630430835628](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023909.png)
...
![image-20230113180730222](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301131807327.png)

![image-20230113180757634](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301131807696.png)
...
![1630432494752](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023010.png)
...
3. 加载SpringMvcConfig配置类
   ...
   ![1630433335744](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023664.png)
...
5. 加载UserController，每个@RequestMapping的名称对应一个具体的方法
   ...
   ![1630433398932](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190023417.png)

   * 此时就建立了 `/save` 和 save方法的对应关系

6. 执行getServletMappings方法，设定SpringMVC拦截请求的路径规则

   ![1630433510528](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024864.png)
...
![1630459727575](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024513.png)
...
![1630460319004](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024178.png)

在Spring的配置类`SpringConfig`中使用注解`@ComponentScan`,当时扫描的范围中其实是已经包含了controller,如:

![1630460408159](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024926.png)
...
![1630461261820](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024386.png)
...
![1630462200947](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024698.png)
...
* PostMan是一款功能强大的网页调试与发送网页HTTP请求的Chrome插件。![1630463382386](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024007.png)
* 作用：常用于进行接口测试
...
![1630463816424](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024834.png)

看到如下界面，就说明已经安装成功。

![1630463887711](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024191.png)

### 3.3 PostMan使用

#### 3.3.1 创建WorkSpace工作空间

![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024568.png)

#### 3.3.2 发送请求

![1630464489898](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024889.png)

#### 3.3.3 保存当前请求

![1630464783034](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190024353.png)
...
![1630466431549](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025727.png)

把环境准备好后，启动Tomcat服务器，后台会报错:

![1630466555934](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025529.png)
...
![1630467830654](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025122.png)
...
![1630467921300](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025035.png)
...
![1630468045733](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025032.png)
...
![1630480536510](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025991.png)
...
![1630480812809](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025756.png)接收参数：
...
![1630480964421](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025264.png)

接收参数:

控制台打印，会发现有中文乱码问题。

![1630481008109](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025645.png)
...
![1630481585729](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025414.png)
...
![1630481772035](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025844.png)
...
![1630482186745](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025555.png)
...
![1630482363291](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025694.png)
...
@RequestMapping("/pojoContainParam")
    ...
    public String pojoContainPojoParam(User user){
        System.out.println("pojo嵌套pojo参数的传递 user==>"+user);
...
![1630482999626](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025493.png)
...
![1630484283773](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190025580.png)
...
![1630484339065](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026427.png)
...
#### JSON普通数组（发送的是json数据要加在参数前@RequestBody）
...
![1630485135061](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026014.png)
...
![1630492624684](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026410.png)
...
![1630493105450](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026842.png)
...
![1630493233550](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026748.png)
...
![1630493450694](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026865.png)
...
```
 ...
 ![1630493501205](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026514.png)
...
![1630493561137](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026167.png)
...
| 类型 | ==形参注解==                                                 |
| 位置 | SpringMVC控制器方法形参定义前面                              |
| 作用 | 将请求中请求体所包含的数据传递给请求参数，此注解一个处理器方法只能使用一次（其实就是解析json数据将其转换为java对象） |
...
* 应用
  * **后期开发中，发送json格式数据为主，@RequestBody应用较广（凡是前端传的是json就用）**
  * **如果发送非json格式数据，选用@RequestParam接收请求参数 （不是json数据可以考虑使用）**
...
![1630494320917](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190026019.png)

#### 步骤4:查看控制台

![1630494443738](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027456.png)
...
![1630494565970](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027080.png)
...
![1630495221038](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027796.png)
...
![1630495347289](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027472.png)

重新启动服务器，重新发送请求测试，SpringMVC就可以将日期时间的数据进行转换

![1630495507353](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027070.png)
...
![1630496385398](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027057.png)
...
![1630497314131](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027016.png)
...
![1630497496785](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027124.png)
...
![1630497741388](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027947.png)
...
![1630497954896](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027133.png)
...
![1630498084047](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190027159.png)
...
![1630503741455](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028292.png)
...
* 使用method属性限定该方法的访问方式为`POST`
  ...
  * 如果发送的不是POST请求，比如发送GET请求，则会报错
    ...
    ![1630505392070](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028137.png)
...
![1630506231379](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028658.png)
...
- 访问并携带参数:
  ...
  ![1630506507096](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028367.png)
...
![1630507339724](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028250.png)
...
![1630508310063](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028604.png)

需求二:新增图片，将新增图书的数据传递到后台，并在控制台打印

![1630508367105](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028040.png)
...
![1630508864017](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190028021.png)
...
![1630509266954](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190029068.png)

测试查询

![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190029863.png)
...
![1630510166433](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190029834.png)

##### 步骤2:访问pages目录下的books.html

打开浏览器输入`http://localhost/pages/books.html`

![1630510225182](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190029763.png)

(1)出现错误的原因?

![1630510264650](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190029884.png)

SpringMVC拦截了静态资源，根据/pages/books.html去controller找对应的方法，找不到所以会报404的错误。

(2)SpringMVC为什么会拦截静态资源呢?

![1630510397429](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208190029610.png)
...
![1630561266760](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638087.png)
...
![1630561591931](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638104.png)
...
* 如何解决上述问题?
  ...
  * 设置错误提示级别
    ...
    ![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638447.png)
...
![1630600844191](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638216.png)

查询所有，测试的结果为:

![1630600927486](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638606.png)
...
![1630652582425](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638611.png)
...
![1630652758221](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638265.png)

#### 删除

`http://localhost/books/14`

![1630652796605](../../../../../../../../第三阶段框架/第二阶段/3.2、2022版SSM框架/SSM资料/课程笔记/基础框架8笔记/SpringMVC笔记/SpringMVC_day02/assets/1630652796605.png)

#### 查询单个

`http://localhost/books/1`

![1630652837682](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638834.png)

#### 查询所有

`http://localhost/books`

![1630652867493](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638415.png)
...
* 在Controller层增删改返回给前端的是boolean类型数据
  ...
  ![1630653359533](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638080.png)

* 在Controller层查询单个返回给前端的是对象

  ![1630653385377](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638204.png)

* 在Controller层查询所有返回给前端的是集合对象

  ![1630653468887](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191638888.png)
...
![1630654293972](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639153.png)
...
![1630654870632](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639974.png)
...
![1630656326477](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639261.png)
...
![1630656982337](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639234.png)
...
* 异常处理器:
  ...
  * 集中的、统一的处理项目中出现的异常。
    ...
    ![1630657791653](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639202.png)
...
![1630657972564](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639862.png)
...
![1630658350945](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639370.png)
...
![1630658606549](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639470.png)
...
![1630659060451](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639761.png)
...
- 业务异常（BusinessException）
  ...
  - 规范的用户行为产生的异常
    ...
    - 用户在页面输入内容的时候未按照指定格式进行数据填写，如在年龄框输入的是字符串
      ...
      ![1630659599983](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639571.png)

  - 不规范的用户行为操作产生的异常

    - 如用户故意传递错误数据

      ![1630659622958](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639837.png)
...
- 其他异常（Exception）
  ...
  - 编程人员未预期到的异常，如:用到的文件不存在
    ...
    ![1630659690341](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639379.png)
...
![1630661162758](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639787.png)

如果传入的是其他参数，会报`SystemException`

![1630661192383](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639257.png)
...
![1630658821746](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639312.png)
...
![1630661781776](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191639682.png)

1. 将`资料\SSM功能页面`下面的静态资源拷贝到webapp下。

![1630663662691](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640289.png)
...
* 新建SpringMvcSupport
  ...
  /**
  registry.addResourceHandler("/assets/**")  //表示文件路径，这里的意思是assets包下的所有文件
          .addResourceLocations("classpath:/assets/js/");  //表示要开放的资源，这里的意思是开放assets包下的js则可以访问，如果assets下还有css不开放,则css无法使用
  **/
  ```
...
![1630670317859](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640782.png)
...
![1630666787456](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640722.png)

### 4.3 添加功能

![1630670332168](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640251.png)
...
![1630668954348](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640271.png)
...
![1630670367812](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640320.png)
...
![1630673984385](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640597.png)
...
![1630676280170](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640726.png)
...
- ![image-20221116153207064](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202211161532266.png)

![1630676903190](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640345.png)
...
![1630677370998](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640613.png)
...
![1630678114224](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640994.png)
...
![1630679464294](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191640448.png)
...
![1630680435269](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191641380.png)
...
![1630680579735](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191641302.png)
...
![image-20220903211815645](SpringMVC.assets/image-20220903211815645-16622111502051.png)

```java
public R<String> upload(MultipartFile file){  // 只有这里MultipartFile是固定的 file 是表单上 name的属性
        // file是临时文件，需要转存在指定的位置，否则本次请求完成后临时文件会删除
        log.info(file.toString());
        // 获取文件原始文件名
        String originalFilename = file.getOriginalFilename();
        // 使用string分割符分割字符串获取文件名后缀
        String suffix = originalFilename.substring(originalFilename.lastIndexOf("."));
        // 使用UUID 生成随机filename 防止文件名重复
        String filename= UUID.randomUUID().toString()+suffix;
        //创建一个目录对象
        File dir=new File(basePath);
        // 判断一下basePath中的盘符是否存在
        if (!dir.exists()){
            // 不存在就创建出来
            dir.mkdirs();
        }
...
- 具体看瑞吉外卖的controller包下的CommonController文件

## 6，在没有mybabatis-config.xml文件下使用Mybatis配置开发

- 如果项目过于复杂需要使用到mybatis-config.xml文件则需要
  - 因为在config包下写了MybatisConfig所以之前在resources下的Mybatis-config.xml文件就不需要再写了
  - 但是**映射文件**就需要写了，因为这里是管理sql语句的文件，所以要在resources包下创建一个**mapper**包（需要和数据层的包命一致 如果数据层叫dao 那么就取为dao）注意里面的**namespace**一定要写**全类名**

![image-20230104165400032](https://cdn.jsdelivr.net/gh/God-ljw/picbed@main/img3/202301041654193.png)
