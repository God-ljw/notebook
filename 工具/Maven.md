...
<img src="https://s2.loli.net/2022/06/03/s8AZeHEVYlX7mcf.png" alt="image-20210726153521381" style="zoom:80%;" />

而Maven提供了一套标准化的项目结构，所有的IDE使用Maven构建的项目完全一样，所以IDE创建的Maven项目可以通用。如下图右边就是Maven构建的项目结构。

<img src="https://s2.loli.net/2022/06/03/5fWeRuSvpJZNGMB.png" alt="image-20210726153815028" style="zoom:80%;" />



**标准化的构建流程：**

<img src="https://s2.loli.net/2022/06/03/qAb2yaYlgvsmK6t.png" alt="image-20210726154144488" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/CTn4zGbmlwV9sOL.png" alt="image-20210726154753631" style="zoom:80%;" />

而Maven使用标准的 ==坐标== 配置来管理各种依赖，只需要简单的配置就可以完成依赖管理。

<img src="https://s2.loli.net/2022/06/03/vDgYubsw9SC8oNx.png" alt="image-20210726154922337" style="zoom:80%;" />

如上图右边所示就是mysql驱动包的坐标，在项目中只需要写这段配置，其他都不需要我们担心，Maven都帮我们进行操作了。

市面上有很多构建工具，而Maven依旧还是主流构建工具，如下图是常用构建工具的使用占比

![image-20210726155212733](https://s2.loli.net/2022/06/03/z68HVZtosxeFbvG.png)
...
<img src="https://s2.loli.net/2022/06/03/vAifcIpqsNj13LB.png" alt="image-20210726155759621" style="zoom:80%;" />

如上图所示就是Maven的模型，而我们先看紫色框框起来的部分，他就是用来完成 `标准化构建流程` 。如我们需要编译，Maven提供了一个编译插件供我们使用，我们需要打包，Maven就提供了一个打包插件提供我们使用等。

<img src="https://s2.loli.net/2022/06/03/9bfIuFgvaQcimJC.png" alt="image-20210726160928515" style="zoom:80%;" />

上图中紫色框起来的部分，项目对象模型就是将我们自己抽象成一个对象模型，有自己专属的坐标，如下图所示是一个Maven项目：

<img src="https://s2.loli.net/2022/06/03/GydPal9NLjzObrE.png" alt="image-20210726161340796" style="zoom:80%;" />

依赖管理模型则是使用坐标来描述当前项目依赖哪儿些第三方jar包，如下图所示

![image-20210726161616034](https://s2.loli.net/2022/06/03/ZvSEoy1QJ4Anml7.png)
...
<img src="https://s2.loli.net/2022/06/03/iBFuaTVM7ZWjI4C.png" alt="image-20210726162605394" style="zoom:70%;" />

如果还可以搭建远程仓库，将来jar包的查找顺序则变为：

> 本地仓库 --> 远程仓库--> 中央仓库

<img src="https://s2.loli.net/2022/06/03/mJskbpN6OSY2nLd.png" alt="image-20210726162815045" style="zoom:70%;" />

### 1.2  Maven安装配置

* 解压 apache-maven-3.6.1.rar 既安装完成

  <img src="https://s2.loli.net/2022/06/03/FEaoWObcfBuS4D6.png" alt="image-20210726163219682" style="zoom:90%;" />

  > 建议解压缩到没有中文、特殊字符的路径下。如课程中解压缩到 `D:\software` 下。

  解压缩后的目录结构如下：

  <img src="https://s2.loli.net/2022/06/03/mYW3bTiIjGkBKD9.png" alt="image-20210726163518885" style="zoom:80%;" />
...
* 配置环境变量 MAVEN_HOME 为安装路径的bin目录
  ...
  <img src="https://s2.loli.net/2022/06/03/2UEgctLZq7GDaV1.png" alt="image-20210726164058589" style="zoom:80%;" />

  在 `Path` 中进行配置

  <img src="https://s2.loli.net/2022/06/03/1GeR2pZn5oP9FJ6.png" alt="image-20210726164146832" style="zoom:80%;" />

  打开命令提示符进行验证，出现如图所示表示安装成功

  <img src="https://s2.loli.net/2022/06/03/eWfLzisHEO8ARKg.png" alt="image-20210726164306480" style="zoom:80%;" />

* 配置本地仓库

  修改 conf/settings.xml 中的 <localRepository> 为一个指定目录作为本地仓库，用来存储jar包。

  <img src="https://s2.loli.net/2022/06/03/meEZTaDXcqHMxo2.png" alt="image-20210726164348048" style="zoom:60%;" />
...
<img src="https://s2.loli.net/2022/06/03/piOTYqoaMHSXlKx.png" alt="image-20210726170404545" style="zoom:70%;" />

而我们使用上面命令需要在磁盘上进入到项目的 `pom.xml` 目录下，打开命令提示符

<img src="https://s2.loli.net/2022/06/03/yZin6worTX1kLNC.png" alt="image-20210726170549907" style="zoom:70%;" />
...
![image-20220603181153094](https://s2.loli.net/2022/06/03/LsF4At6V1Zhp8q3.png)

同时在项目下会出现一个 `target` 目录，编译后的字节码文件就放在该目录下

<img src="https://s2.loli.net/2022/06/03/4PCsNR78XhkUjOY.png" alt="image-20210726171346824" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/6y4bejnCNumvHYz.png" alt="image-20210726171558786" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/GyCrDmxqb3swBEc.png" alt="image-20210726171747125" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/kU7bvYRQsTiZPxC.png" alt="image-20210726172343933" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/JmIf9BwXRG42jgM.png" alt="image-20210726172709112" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/QrKalRAMPbmCGkz.png" alt="image-20210726173153576" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/Eu4yfHrbRcBJzxY.png" alt="image-20210726173619353" style="zoom:80%;" />
...
* 选择 IDEA中 File --> Settings
  ...
  <img src="https://s2.loli.net/2022/06/03/KhTL5guo9R6PHDE.png" alt="image-20210726174202898" style="zoom:80%;" />

* 搜索 maven 

  <img src="https://s2.loli.net/2022/06/03/1ENaVJQehTuHqPC.png" alt="image-20210726174229396" style="zoom:80%;" />

* 设置 IDEA 使用本地安装的 Maven，并修改配置文件路径

  <img src="https://s2.loli.net/2022/06/03/3I8UJHLkWxoemah.png" alt="image-20210726174248050" style="zoom:70%;" />
...
![image-20210726174718176](https://s2.loli.net/2022/06/03/ubs9GQAcWzXaflT.png)
...
* 创建模块，选择Maven，点击Next
  ...
  <img src="https://s2.loli.net/2022/06/03/rF5v92ptCNAB3Hd.png" alt="image-20210726175049876" style="zoom:90%;" />

* 填写模块名称，坐标信息，点击finish，创建完成

  <img src="https://s2.loli.net/2022/06/03/n8czSoqZhsPTYBK.png" alt="image-20210726175109822" style="zoom:80%;" />

  创建好的项目目录结构如下：

  ![image-20210726175244826](https://s2.loli.net/2022/06/03/ODbGMBsuJWLN8SQ.png)
...
* 选择右侧Maven面板，点击 + 号
  ...
  <img src="https://s2.loli.net/2022/06/03/n2GS9EUKATjzs1f.png" alt="image-20210726182702336" style="zoom:70%;" />

* 选中对应项目的pom.xml文件，双击即可

  <img src="https://s2.loli.net/2022/06/03/gTd2MVEAwHRYbmN.png" alt="image-20210726182648891" style="zoom:70%;" />

* 如果没有Maven面板，选择

  View --> Appearance --> Tool Window Bars

  <img src="https://s2.loli.net/2022/06/03/84CsVrygnPLxdMU.png" alt="image-20210726182634466" style="zoom:80%;" />



可以通过下图所示进行命令的操作：

<img src="https://s2.loli.net/2022/06/03/OBwlEmPv2b75seN.png" alt="image-20210726182902961" style="zoom:80%;" />

**配置 Maven-Helper 插件** 

* 选择 IDEA中 File --> Settings

  <img src="https://s2.loli.net/2022/06/03/35jmUoFfpLuybeB.png" alt="image-20210726192212026" style="zoom:80%;" />

* 选择 Plugins

  <img src="https://s2.loli.net/2022/06/03/lTj6RqBzHDgGxmS.png" alt="image-20210726192224914" style="zoom:80%;" />

* 搜索 Maven，选择第一个 Maven Helper，点击Install安装，弹出面板中点击Accept

  <img src="https://s2.loli.net/2022/06/03/7YUhcy5NImjoZrC.png" alt="image-20210726192244567" style="zoom:80%;" />

* 重启 IDEA

安装完该插件后可以通过 选中项目右键进行相关命令操作，如下图所示：

![image-20220603181309826](C:/Users/10850/AppData/Roaming/Typora/typora-user-images/image-20220603181309826.png)
...
* 定义坐标的 groupId，artifactId，version
  ...
  <img src="https://s2.loli.net/2022/06/03/ZifFgjqTAQPypeS.png" alt="image-20210726193105765" style="zoom:70%;" />

* 点击刷新按钮，使坐标生效

  <img src="https://s2.loli.net/2022/06/03/iYZv8UQux9IDhqJ.png" alt="image-20210726193121384" style="zoom:60%;" />
...
* 在 pom.xml 中 按 alt + insert，选择 Dependency
  ...
  <img src="https://s2.loli.net/2022/06/03/S5yl3OEKBcdgovG.png" alt="image-20210726193603724" style="zoom:60%;" />

* 在弹出的面板中搜索对应坐标，然后双击选中对应坐标

  <img src="https://s2.loli.net/2022/06/03/YXdrD7CcjepxlKi.png" alt="image-20210726193625229" style="zoom:60%;" />
...
* 选择 IDEA中 File --> Settings
  ...
  <img src="https://s2.loli.net/2022/06/03/fclIBkqACiprjhM.png" alt="image-20210726193854438" style="zoom:60%;" />

* 在弹出的面板中找到 Build Tools

  <img src="https://s2.loli.net/2022/06/03/sMQOwzpSouXhr4C.png" alt="image-20210726193909276" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2022/06/03/QDPgTquzNBYMLh1.png" alt="image-20210726194703845" style="zoom:70%;" />
...
![1630768703430](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642403.png)
...
![1630768869208](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642404.png)
...
![1630769969416](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642405.png)
...
![1630771178137](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642406.png)

##### 步骤2:项目中创建domain包

在`maven_03_pojo`项目中创建`com.itheima.domain`包，并将`maven_02_ssm`中Book类拷贝到该包中

![1630771371487](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642407.png)

##### 步骤3:删除原项目中的domain包

删除后，`maven_02_ssm`项目中用到`Book`的类中都会有红色提示，如下:

![1630771505703](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642408.png)
...
![1630771987325](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642409.png)
...
![1630773180969](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642410.png)

安装成功后，在对应的路径下就看到安装好的jar包

![1630773262441](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642411.png)
...
![1630773580067](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642412.png)

##### 步骤2:项目中创建dao包

在`maven_04_dao`项目中创建`com.itheima.dao`包，并将`maven_02_ssm`中BookDao类拷贝到该包中

![1630773695062](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642413.png)

在`maven_04_dao`中会有如下几个问题需要解决下:

![1630773958756](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642414.png)
...
![1630774696344](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642415.png)

再次对`maven_02_ssm`项目进行编译，又会报错，如下:

![1630774780211](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642416.png)
...
![1630774917743](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642417.png)

安装成功后，在对应的路径下就看到了安装好对应的jar包

![1630774946856](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642418.png)
...
![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642419.png)
...
![1630819455928](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642420.png)
...
![1630819768305](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642421.png)

在Dependencies中移除自己所添加`maven_03_pojo`依赖后，打开BookServiceImpl的类，你会发现Book类依然存在，可以被正常使用

![1630819826163](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642422.png)

这个特性其实就是我们要讲解的==依赖传递==。

依赖是具有传递性的:

![1630853726532](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642423.png)
...
![1630820964663](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642424.png)
...
![1630853443920](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642425.png)

如果想更全面的查看Maven中各个坐标的依赖关系，可以点击Maven面板中的`show Dependencies`

![1630853519736](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642426.png)
...
![1630854436435](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642427.png)
...
![1630854923484](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642428.png)
...
![1630858596147](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642429.png)
...
![1630859532119](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642430.png)
...
![1630859797123](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642431.png)
...
![1630860344968](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642432.png)
...
![1630862406709](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642433.png)

这样我们就可以解决刚才提到的第一个问题，将子项目中的公共jar包抽取到父工程中进行统一添加依赖，这样做的可以简化配置，并且当父工程中所依赖的jar包版本发生变化，所有子项目中对应的jar包版本也会跟着更新。

![1630943390187](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642434.png)

#### 步骤4:优化子项目依赖版本问题

如果把所有用到的jar包都管理在父项目的pom.xml，看上去更简单些，但是这样就会导致有很多项目引入了过多自己不需要的jar包。如上面看到的这张图:

![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642432.png)
...
![1630944335419](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642435.png)
...
![1630946592924](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642436.png)

##### 步骤2:创建子项目

该项目可以被聚合工程管理，同时会继承父工程。

![1630947082716](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642438.png)
...
![1630947403475](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642439.png)
...
![1630947749661](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642440.png)
...
![1630977419627](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642441.png)
...
![1630977885030](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642442.png)
...
![1630948929828](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642443.png)
...
![1630981519370](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642444.png)

具体如何查看这些属性:

在cmd命令行中输入`mvn help:system`

![1630981585748](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642445.png)
...
![1630982018031](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642446.png)

这里面有两个单词，SNAPSHOT和RELEASE，它们所代表的含义是什么呢?

我们打开Maven仓库地址`https://mvnrepository.com/`

![1630983148662](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642447.png)
...
![1630983617755](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642448.png)
...
![1630983967960](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642449.png)

查看到的结果为:

![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642442.png)
...
![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642450.png)

虽然已经能够实现不同环境的切换，但是每次切换都是需要手动修改，如何来实现在不改变代码的前提下完成环境的切换呢?

#### 步骤5:命令行实现环境切换

![1630984476202](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642451.png)

#### 步骤6:执行安装并查看env_test环境是否生效**

查看到的结果为`jdbc:mysql://127.3.3.3:3306/ssm_db`

![](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642452.png)
...
![1630985300814](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642453.png)
...
![1630985411766](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642454.png)
...
![1630986926124](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642455.png)
...
![1630987192620](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642456.png)
...
![1630988572349](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642457.png)

#### 步骤2:启动Nexus

![1630988673245](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642458.png)
...
![1630988939301](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642459.png)
...
![1630988857125](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642460.png)

#### 步骤4:首次登录重置密码

![1630988983159](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642461.png)

输入用户名和密码进行登录，登录成功后，出现如下页面

![1630989052183](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642462.png)

点击下一步，需要重新输入新密码，为了和后面的保持一致，密码修改为`admin`

![1630989094756](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642463.png)

设置是否运行匿名访问

![1630989122737](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642464.png)

点击完成

![1630989136097](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642465.png)
...
![1630989320979](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642466.png)
...
![1630990244010](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642467.png)
...
![1630990538229](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642468.png)

上面所说的这些内容，我们需要在本地Maven的配置文件`settings.xml`中进行配置。

#### 步骤1:私服上配置仓库

![1630991211000](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642469.png)
...
![1630991535107](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642470.png)
...
![1630992305191](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642471.png)
...
![1630992513299](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642472.png)

现在发布是在itheima-snapshot仓库中，如果想发布到itheima-release仓库中就需要将项目pom.xml中的version修改成RELEASE即可。

如果想删除已经上传的资源，可以在界面上进行删除操作:

![1630992952378](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642473.png)

如果私服中没有对应的jar，会去中央仓库下载，速度很慢。可以配置让私服去阿里云中下载依赖。

![1630993028454](https://cdn.jsdelivr.net/gh/God-ljw/picbed/img/202208191642474.png)
